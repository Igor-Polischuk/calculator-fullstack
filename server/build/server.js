...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.calculatorDatabaseConnection = void 0;\nconst Connection_1 = __webpack_require__(/*! ./Connection */ \"./src/modules/database/Connection.ts\");\nconst CalculatorHistoryModel_1 = __webpack_require__(/*! ./models/CalculatorHistoryModel */ \"./src/modules/database/models/CalculatorHistoryModel.ts\");\nconst calculatorDatabaseConnection = new Connection_1.Connection({\n    password: \"root\",\n    port: Number(\"5432\") || 5432,\n    user: \"admin\",\n    host: process.env.POSTGRES_HOST || 'localhost',\n});\nexports.calculatorDatabaseConnection = calculatorDatabaseConnection;\ncalculatorDatabaseConnection.createTable('calculatorHistory', CalculatorHistoryModel_1.calculatorHistoryModel);\n\n\n//# sourceURL=webpack://webpack-server-config/./src/modules/database/index.ts?");

/***/ }),

/***/ "./src/modules/database/models/CalculatorHistoryModel.ts":
/*!***************************************************************!*\
  !*** ./src/modules/database/models/CalculatorHistoryModel.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.calculatorHistoryModel = void 0;\nexports.calculatorHistoryModel = [\n    { name: 'expression', type: 'TEXT', constraints: ['NOT NULL'] },\n    { name: 'result', type: 'FLOAT', constraints: ['NOT NULL'] }\n];\n\n\n//# sourceURL=webpack://webpack-server-config/./src/modules/database/models/CalculatorHistoryModel.ts?");
