import { ExpressionCalculation } from './services/processing/ExpressionCalculation';
...
export class CalculatorController implements ICalculatorController {
  private expressionCalculation = new ExpressionCalculation()
  ...
  private calculate = (expression: string) => this.expressionCalculation.processBracketedExpression(expression)
}
